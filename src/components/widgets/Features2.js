  ...
  <section className="bg-primary-50 text-gray-800 dark:bg-slate-800">
    <div className="container mx-auto max-w-6xl p-4 py-16 md:py-20 md:px-8">
      <div className="mb-16 text-center">
        ...
        <h2 className="text-3xl font-bold tracking-tight text-gray-900 dark:text-white sm:text-5xl">Aliquip definiebas ad est</h2>
        <p className="mx-auto mt-4 max-w-3xl text-xl text-gray-600 dark:text-slate-400">Quando cetero his ne, eum admodum sapientem ut.</p>
      </div>
      <div className="mb-24 grid md:grid-cols-2 md:items-center md:gap-16">
        <div>
          <h3 className="text-2xl font-bold tracking-tight text-gray-900 dark:text-white sm:text-3xl">Ad vix debet docendi</h3>
          ...
          <div className="mt-12 space-y-10">
            ...
            <div className="flex">
              ...
              <div className="ml-4">
                <h4 className="text-lg font-medium leading-6 text-gray-900 dark:text-white">Cu imperdiet posidonium sed</h4>
                <p className="mt-2 text-gray-600 dark:text-slate-400">
            ...
            <div className="flex">
              ...
              <div className="ml-4">
                <h4 className="text-lg font-medium leading-6 text-gray-900 dark:text-white">Nulla omittam sadipscing mel ne</h4>
                <p className="mt-2 text-gray-600 dark:text-slate-400">
      ...
      <div className="grid md:grid-cols-2 md:items-center md:gap-16">
        <div className="md:col-start-2">
          <h3 className="text-2xl font-bold tracking-tight text-gray-900 dark:text-white sm:text-3xl">Eam nibh gloriatur ex</h3>
          <p className="mt-3 text-lg text-gray-600 dark:text-slate-400">
          ...
          <div className="mt-12 space-y-10">
            <div className="flex">
              ...
              <div className="ml-4">
                <h4 className="text-lg font-medium leading-6 text-gray-900 dark:text-white">Cibo augue offendit has ad</h4>
                <p className="mt-2 text-gray-600 dark:text-slate-400">
            ...
            <div className="flex">
              ...
              <div className="ml-4">
                <h4 className="text-lg font-medium leading-6 text-gray-900 dark:text-white">At eum ferri luptatum lobortis</h4>
                <p className="mt-2 text-gray-600 dark:text-slate-400">
            ...
            <div className="flex">
              ...
              <div className="ml-4">
                <h4 className="text-lg font-medium leading-6 text-gray-900 dark:text-white">Dicunt verterem evertitur eu sea</h4>
                <p className="mt-2 text-gray-600 dark:text-slate-400">
