...
const WidgetWrapper = ({ children, id, hasBackground, backgroundKey, containerClass }: WrapperTagProps) => (
  <section className="relative not-prose scroll-mt-[72px]" id={id}>
    <Background hasBackground={hasBackground} backgroundKey={backgroundKey} />
    <div
      className={twMerge(
